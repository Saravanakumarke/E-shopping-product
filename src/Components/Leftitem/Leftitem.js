              ...
              <aside className={styles.asidenav}>
                  ...
                  <div className={styles.filterarea}>
                     ...
                     <span className={styles.range}>
                         <input type="range" className={styles.rangeslider} min="0" max="500" onChange={(event)=>setRangevalue(event.target.value)} />
                         <button className={styles.btn2}>Filter</button>
                         <p className={styles.price}>Price:<span className={styles.amount}>$0-${rangevalue}</span></p>
                     </span>
                  </div>
