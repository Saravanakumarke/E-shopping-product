    ...
    return (
        <div className={styles.container}>
          ...
          <div className={styles.footer}>
              ...
              <Link to='cars' className={styles.link}>   <li className={`${styles.pagename} + " " + ${styles.active}`}><p className={styles.no}>1</p></li></Link> 
              <Link to='/carpageno2' className={styles.link}>  <li className={styles.pagename}><p className={styles.no}>2</p></li></Link>
